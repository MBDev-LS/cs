...
# Idea: Create new move - radjuaF which is the Faujdar move but rotated 90 degrees.
# Author: Damian
...
class Dastan:
	...
	def __CreateMoveOptionOffer(self):
		...
		self._MoveOptionOffer.append("radjuaf")
	...
	def __CreateRadjuafMoveOption(self, Direction):
		NewMoveOption = MoveOption("radjuaf")
		NewMove = Move(-1 * Direction, 0)
		NewMoveOption.AddToPossibleMoves(NewMove)
		NewMove = Move(1 * Direction, 0)
		NewMoveOption.AddToPossibleMoves(NewMove)
	...
	def __CreateMoveOption(self, Name, Direction):
		if Name == "chowkidar":
			...
			return self.__CreateRadjuafMoveOption(Direction)
		elif Name == "jazair":
	...
	def __CreateMoveOptions(self):
		...
		self._Players[0].AddToMoveOptionQueue(self.__CreateMoveOption("radjuaf", 1))
		...
		self._Players[1].AddToMoveOptionQueue(self.__CreateMoveOption("radjuaf", -1))
