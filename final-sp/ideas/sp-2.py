...
# Idea: Take coordinate inputs separately
...
class Dastan:
	...
	def __GetSquareReference(self, Description):
		rowNumber = input(f'Enter the row number of the square {Description}: ')
		columnNumber = input(f'Enter the column number of the square {Description}: ')
